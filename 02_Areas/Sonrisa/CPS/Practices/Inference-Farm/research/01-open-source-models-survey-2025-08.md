---
title: "Open-Source LLM Model Survey (August 2025)"
date: 2025-08
status: active
description: "Comprehensive survey of 14 open-source LLM model families available for self-hosted deployment as of August 2025 (Qwen 3, DeepSeek V3/R1, LLaMA 3.3, Gemma 3, GPT-oss, AM-Thinking-v1, Phi-3/4, Mixtral, Yi-1.5, CodeLlama, Llama 4 Scout/Maverick, Apertus, Falcon 3, Mistral 7B). Includes 20-dimension scoring rubric (capabilities / performance / engineering / license) per use-case (Coding Assistant / Chat UI / API Integration) and curated authoritative benchmark + tooling resource links. Reference dossier for Inference Farm model-selection decisions."
practice_area: cps-inference-farm
type: research-dossier
audience: internal-engineering
provenance: "moved from 02_Areas/Sonrisa/CPS/Services/Inference Farm/Open Source Models.md on 2026-05-27. A near-duplicate Extended version existed at the same folder — superseded, only this canonical version retained."
id: 5b3c8e91-7d24-4a67-9f18-4c0d6a2f7e83
