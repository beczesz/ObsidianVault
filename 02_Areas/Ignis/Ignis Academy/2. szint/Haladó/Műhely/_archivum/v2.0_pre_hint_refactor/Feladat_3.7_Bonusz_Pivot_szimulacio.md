...
status: active
description: "Gyakorlati feladat, amely arra kéri a felhasználót, hogy egy kkv-k számára pályázati stratégiát szimuláljon: három-négy hipotetikus forgatókönyvet dolgozzon ki a TransOffice esetén, megvizsgálja az eligibilitás, támogatási összeg és pontozás változásait, majd rangsorolja a lehetőségeket. Az AI-t forgatókönyv-generátorként"
description_source: auto
description_hash: df2d88789ecbbc9a
id: 882c7407-82af-4c94-bd17-075317694803
...
**Scenario A — Mi van ha 5 elektromos jármű helyett 8-at vennénk?**
> "Olvasd át a pályázati kiírást. Ha 5 jármű helyett 8-at vennénk (3 furgon + 5 elektromos kis-haszongépjármű), mi változna?
> - Maximum támogatás?
> - Eligibility-be még belefér?
> - Pontozás?
> - Önerő igény?
> - Megvalósítási kockázat?"

**Scenario B — Mi van ha NEM bérelt, hanem saját telephelyen lennénk?**
> "Ha a TransOffice saját ingatlanban lenne (mondjuk most megvásárolnánk a Béla bácsi területet) — hogyan változna a pályázati anyag? Mit kellene másképp dokumentálni?"

**Scenario C — Mi van ha 2 kisebb pályázattal indulnánk 1 nagy helyett?**
> "Lehetne két fázisban pályázni: most 2 járműre + 1 év múlva még 3-ra? Mi a kockázata és mi az előnye ennek a stratégiának?"

**Scenario D — Mi van ha egy szövetkezetbe lépnénk be?**
> "Ha a TransOffice egy regionális szövetkezetbe lépne be más KKV-kkal — vannak előnyösebb pályázati pozíciók (több keret, jobb pontozás)? Tervezhető-e ez?"
