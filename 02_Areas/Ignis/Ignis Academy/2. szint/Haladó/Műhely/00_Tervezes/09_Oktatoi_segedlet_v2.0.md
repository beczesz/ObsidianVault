---
title: "🎬 Oktatói segédlet v2.0 — Ignis Academy Haladó AI Workshop"
date: 2026-05-14
author: Becze Szabolcs
status: active
description: "Instruktor-vezetésű 4 órás AI workshop tananyag a TransOffice cégszimulációhoz, amely 6 fázisban (káoszkezelés, TODO-rendezés, pályázatanalízis, kommunikáció, kitöltés, webdesign) végigvezeti a résztvevőket egy EU-pályázat-beadási folyamaton. Oktatók számára készült, részletes időzítéssel, promptokkal és"
description_source: auto
description_hash: 39566503135ecd19
id: 2a2e65ad-4880-4066-a35f-080b5e6bce63
...
📍 **MONDOM:** *„**Ez a táblát egy tanácsadó 3000 EUR-ért adja. 5 perc, ingyen.** De most jön a neheze: ezeket az adatokat be is kell szerezni. Email a könyvelőnek románul, szerződés-ellenőrzés, prezentáció Mártonnak. **F4 következik.**"*

---

## 🎬 F4 — Multi-persona kommunikáció (1:57 → 2:34, 37 perc)  <a id="f4"></a>

**Cél:** A 2 piros pont megoldása **emailekkel**. A tanulók mindkét felkérő emailt **saját Cowork-jén** írják meg, az oktató mutatja a beérkező válaszokat.
**Stációk:** 2 db (felkérő email Béla bácsinak magyarul + felkérő email Mihaelának románul).

| Idő | Mód | Mit |
|---|---|---|
| 1:57-2:00 | 🎤 OKTATÓ | Átvezetés: „3 ember, 2 piros pont" |
| 2:00-2:05 | 🎤 OKTATÓ | F4.1 DEMO: bérleti szerződés deep-check + Béla bácsi cross-doc red flag |
| 2:05-2:10 | ⏸ STÁCIÓ | F4.1 STÁCIÓ — felkérő email **Béla bácsinak** (magyarul) |
| 2:10-2:13 | 🎤 OKTATÓ | F4.1 DEMO: **a válasz beérkezik** |
| 2:13-2:18 | ⏸ STÁCIÓ | F4.2 STÁCIÓ — felkérő email **Mihaelának** (románul) |
| 2:18-2:24 | 🎤 OKTATÓ | F4.2 DEMO: **a válasz beérkezik + Excel-elemzés** (EBITDA) |
| 2:24-2:34 | 🎤 OKTATÓ | F4.3 DEMO: CEO update PPT |

### 1:57-2:00 — Átvezetés

📍 **MONDOM:** *„A Data Completion Board kész — 14 feladat, 8 felelős. **2 piros pont van**: a telephely-stabilitás (Béla bácsi) és a pénzügyi adatok (Mihaela). **Ezt a 2 pontot mostantól kell megoldani — és nézzétek, mi a megoldás eszköze**: két email. Egy magyar Béla bácsinak, egy román Mihaelának. **Ti írjátok meg őket.**"*
