...
status: active
description: "Haladó AI-használat oktatására szervezett 4 órás workshop tanára számára készült részletes segédlet, amely lépésről lépésre instrukciókat, időbeosztást, demókat és egy konkrét cegészeti esettanulmányt tartalmaz."
description_source: auto
description_hash: fe83bb05e5bd795c
id: f5306f66-4720-4a9e-a08d-395bb796c0d2
...
| ☐ | `Ghidul-solicitantului-Mobilitate-Verde-IMM-2026.md` ELŐRE NYITVA | Másik tab |
| ☐ | `szerzodes_chirie_TransOffice_2018.docx` letöltve | Asztalon |
| ☐ | `bilant_TransOffice_2024_2025.xlsx` letöltve | Asztalon |
...
- 🖥 **Csinálom:** Megmutatom a `Palyazat_kiiras/Ghidul-solicitantului-Mobilitate-Verde-IMM-2026.pdf` borítóját
...
### Asset
- `Tananyag/03_Dontes_Elemzes/Palyazat_kiiras/Ghidul-solicitantului-Mobilitate-Verde-IMM-2026.md`
...
- 🖥 **Csinálom:** Prompt: „Most írj emailt **románul** Mihaela Florian-nek, a külsős könyvelőnek. Kérjünk pénzügyi adatokat a 2023 és 2024 évre: árbevétel, EBITDA, alkalmazotti adatok. Hangnem: professzionális de közvetlen. A pályázat AFM Mobilitate Verde 2026."
...
- 🖥 **Csinálom:** Megnyitom a `mihaela_konyvelo_valasz/email.md`-t és a `bilant_TransOffice_2024_2025.xlsx`-et
...
egy EU pályázatról (elektromos autó flotta, AFM Mobilitate Verde 2026).
...
```
Olvasd át a Palyazat_kiiras/Ghidul-solicitantului-Mobilitate-Verde-IMM-2026.md
...
```
Itt van Mihaela visszaküldött bilanță: bilant_TransOffice_2024_2025.xlsx
Számítsd ki és mutasd be:

1. Árbevétel 2024 vs 2025 (RON-ban + %)
2. EBITDA 2025 vs 2025 (RON-ban + marzs %)
