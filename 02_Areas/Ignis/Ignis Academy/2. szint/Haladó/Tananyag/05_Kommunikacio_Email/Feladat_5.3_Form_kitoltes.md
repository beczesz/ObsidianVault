...
status: active
description: "Instruktor-demonstráció arról, hogyan tölt ki az AI egy 40 mezős pályázati formot 60-90 másodperc alatt az előző fázisok adataiból, amely 1,5-2 órás kézi munkát helyettesít. A tanulók megfigyelik az adatkonzisztenciát és azt, mely mezők maradnak manuálisan kitöltendőek."
description_source: auto
description_hash: b9e26c55ab090121
id: 855bc4ec-36ae-4d67-bb0c-89ba0efa76b9
...
Miután az F5.1 (Plan de afaceri) és F5.2 (Csomag) outputjai megvannak, és a `formular_depunere_AFM_Mobilitate_Verde.html` projekt-kontextusban van, másold be ezt a promptot:
...
A Cowork **~60-90 másodperc alatt** kitölti a ~40 mezőt. Hasonlítsd össze a `STÁCIÓ 5.B` manuális idő-becslésével — ez **mérhető 60× sebességbeli különbség**.
