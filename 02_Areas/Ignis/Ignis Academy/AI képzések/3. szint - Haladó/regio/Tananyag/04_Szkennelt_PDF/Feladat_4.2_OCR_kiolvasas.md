---
title: "Feladat 4.2: OCR élőben: szkennelt ajánlat → md tábla (DEMO)"
date: 2026-07-01
author: Becze Szabolcs
status: active
description: "F4 oktatói demó: a szkennelt (kép-only) Napsugár-ajánlatból az AI OCR-rel gépi-olvasható, tételes markdown táblát nyer ki, és rögtön kontroll-összeggel ellenőrzi. A demó őszinte: bemutatja, hol pontos és hol hibázhat az OCR, és miért kell mindig ellenőrizni."
id: 23b04a6b-6142-4d29-8f8d-7e9b6a1f5e3c
index_schema_version: 1
bdos_index: true
tags: [ignis-academy, halado, regio-consult, f4, feladat, demo, ocr]
---
# Feladat 4.2: OCR élőben: szkennelt ajánlat → md tábla (DEMO)
...
```
A kivitelező szkennelt, kép-only ajánlata a projektben a
08_Dosare_de_achizitii/04.04_DAL_Lucrari mappában van (a scan PDF).
...
Kontroll (ne tippelj): (a) minden sorra egységár × mennyiség = a sor Valoare
értéke, (b) az összes Valoare összege = a dokumentum feltüntetett végösszege.
Ha egy szám bizonytalanul olvasható, ezzel a két kontrollal old fel, és jelöld
a bizonytalan cellákat.

Végül mentsd el az eredményt md fájlként UGYANABBA a DAL mappába
(08_Dosare_de_achizitii/04.04_DAL_Lucrari), a standard elnevezéssel, a scan
melletti következő sorszámmal:
04.04.d_THR_Oferta_kivitelezo_OCR_ISZ_<mai dátum>.md
Így az F5 összevetés közvetlenül erre az elmentett md-re tud majd épülni.
```
...
## Mi következik (F4 stáció + F5)
A résztvevők most maguk mérlegelik, mikor éri meg ez a munka és mikor jobb a vektoros export (4.3). Aztán az F5-ben ezt a kinyert adatot összevetjük a kiírással.
