...
1. **Szolgáltató azonosítása**
   - Cég neve (Exar Labs SRL / vagy a Deák Húsmíves jogi entitása?)
   - CUI/CIF szám
   - Székhely címe
...
7. **Felelősségkorlátozás**
   ...
   - Platform üzemeltetésért az Exar Labs felel
...
```
Szolgáltató: [Exar Labs SRL / Deák Húsmíves entitás — TISZTÁZNI]
CUI: [...]
...
|---|--------|-------------|----------|
| 1 | **Ki a jogi szolgáltató?** Exar Labs SRL vagy a Deák Húsmíves? | Az ÁSZF és az Impresszum ettől függ. Ha Exar Labs üzemelteti a platformot és a DH szállít, mindkettőt meg kell nevezni. | v0.3 beta előtt |
...
- [ ] Ki a jogi szolgáltató? (Exar Labs / DH / mindkettő)
