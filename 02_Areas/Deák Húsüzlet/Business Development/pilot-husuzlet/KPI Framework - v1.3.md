...
status: LIVE — Firebase + UTM/QR tracking aktív
...
> **🎉 Sprint 2 LEZÁRVA 2026-04-15** — A teljes analytics stack telepítve, MÉRÉS-KÉSZ:
> - ✅ Firebase Analytics SDK (DH-104)
> - ✅ Event DocType + Visitor Identity Map (DH-43)
> - ✅ QR code generation 3 forrással (DH-44)
> - ✅ UTM tracking + first-touch attribution (DH-80)
> - ✅ Failure event tracking (DH-81)
> - ✅ North Star KPI dashboard (DH-82)
> - ✅ QR tracking kiértékelés (DH-109)
>
> ⚠️ **FONTOS:** A beta NEM indult el — a valódi mérés a **v0.3 Savings Engine release után** (~2026-05-15) kezdődik. Az infrastruktúra ÉLES, de mérhető felhasználói aktivitás még nincs.
...
|---------|-----------|--------|
| 🟢 **GREEN — scale** | ≥50 reg, ≥20 visszatérő (14 napon belül), ≥40% second order | Phase 2 tervezése |
