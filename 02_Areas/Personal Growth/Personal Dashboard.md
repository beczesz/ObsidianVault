...
const DAYS      = 90;                   // rolling window size
const MINY      = 86;                   // rolling window size
...
- Active Areas progress
	...
	- ETc...
# TODO
- [x] Talk to Raymond Sanchez 📅 2025-10-28 ✅ 2026-04-24
- [x] Minic Studio 📅 2025-10-28
- [ ] Kallai Emannuel  📅 2025-10-28 
- [x] Írni egy összesítést Casey nek 📅 2026-02-17
